  ...
  const features = [
    {
      ...
      description:
        "As a small company, marketing is a key part of growth, and luckily for you, we specialize in that.",
      image: "/vite/assets/most-experienced-partners-DX4ZPbr4.jpg",
      links: [
        {
          text: "Learn more",
          href: "https://example.com/marketing-guide",
        },
      ],
    },
    {
      ...
      description:
        "We have a wide range of companies that we publicize. All you have to do is pick your poison.",
      image: "/vite/assets/investor-network-DsrGWUIM.jpg",
      links: [
        {
          text: "Explore the companies",
