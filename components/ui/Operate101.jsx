  ...
  return (
    ...
    >
      <div className="flex flex-wrap md:flex-nowrap justify-between items-start w-full max-w-4xl gap-10">
        {/* Left Box */}
        <div
          className="w-80 h-80 rounded-lg flex flex-col items-center justify-center relative"
          style={{
        ...
        {/* Right Box - Inverted */}
        <div
          className="w-80 h-80 rounded-lg flex flex-col-reverse items-center justify-center relative"
          style={{
            backgroundImage: 'url("/pexels-fauxels-3184603.jpg")',
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            backgroundRepeat: 'no-repeat',
          }}
